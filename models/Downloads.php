...
class Downloads extends Content
{
    ...
    public function getDetail()
    {
        if(empty($this->_detail)) {
            if ($this->isNewRecord) {
                $this->_detail = new ContentDetail(['scenario' => ContentDetail::SCENARIO_DOWNLOAD]);
            } else {
                $this->_detail = $this->hasOne(ContentDetail::class, ['content_id' => 'id'])->one();
                $this->_detail->scenario = ContentDetail::SCENARIO_DOWNLOAD;
            }
        }
        return $this->_detail;
    }
